...
public class CustomerList {
  public static void main(String [] args) throws IOException {
   ...
   while(Character.isLetter(customerAmountStrg.charAt(0))||Character.isWhitespace(customerAmountStrg.charAt(0))){
     ...
     for(int i = 1; i <= customerAmount; i++){
      ...
      while(Character.isDigit(customerPCode.charAt(0))){ 
          JOptionPane.showMessageDialog(null,"Invalid input");
          customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      }  
       while(Character.isLetter(customerPCode.charAt(1))){ 
         JOptionPane.showMessageDialog(null,"Invalid input");
         customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      } 
      while(Character.isDigit(customerPCode.charAt(2))){ 
         JOptionPane.showMessageDialog(null,"Invalid input");
         customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      }      
      while(Character.isWhitespace(customerPCode.charAt(3))){ 
         JOptionPane.showMessageDialog(null,"Invalid input");
         customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      }  
      while(Character.isLetter(customerPCode.charAt(4))){ 
          JOptionPane.showMessageDialog(null,"Invalid input");
          customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      }  
       while(Character.isDigit(customerPCode.charAt(5))){ 
         JOptionPane.showMessageDialog(null,"Invalid input");
         customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      } 
      while(Character.isLetter(customerPCode.charAt(6))){ 
         JOptionPane.showMessageDialog(null,"Invalid input");
         customerPCode =  JOptionPane.showInputDialog("Enter " + customerName + "'s Postal Code"+"L#L #L#");
      }      
